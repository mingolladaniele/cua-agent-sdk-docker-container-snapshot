...
class SnapshotCallback:
    ...
    async def _create_snapshot_if_enabled(
        ...
        try:
            ...
            logger.info(f"Created {trigger.value} snapshot for container {self._current_container_id}")
    ...
    async def on_run_start(self, kwargs: Dict[str, Any], old_items: List[Dict[str, Any]]) -> None:
        ...
        try:
            ...
            logger.info(f"Agent run started - container: {self._current_container_id}, run: {self._current_run_id}")
    ...
    async def restore_latest_snapshot(self, container_name_suffix: str = "restored") -> str:
        ...
        return await self.snapshot_manager.restore_snapshot(
