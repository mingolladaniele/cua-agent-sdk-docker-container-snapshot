...
async def basic_snapshot_operations():
    ...
    config = SnapshotConfig(
        storage_path="./example_snapshots",
    ...
    try:
        ...
        print(f"5. Restoring from snapshot...")
...
async def advanced_configuration_example():
    ...
    manager = SnapshotManager(config=advanced_config)
